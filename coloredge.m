%%This code implements the Color Edge Detection in RGB Using Jointly
%%Euclidean Distance and Vector Angle of Wesolkowski and Jernigan.
%%This edge detection algorithm uses not only intensity information, but
%%hue and saturation as well to help find edge.  However, these
%%calculations using hue and saturation can be performed in the RGB space,
%%as discussed in Wesolkowski and Jernigan's paper.

close all;
clear all;

%%Read in an image, INCLUDING its color data.
I1 = imread('shoreline.jpg');
figure;
imshow(I1);
hold on;
